...
const RegistrationForm = () => {
  ...
  return (
    ...
    <div className="max-w-md w-full content-center bg-white rounded-lg shadow-xl p-8 neumorphic-input">
      <div>
        <h2 className="text-3xl font-bold  text-white-900 mb-4">Register Here</h2>
      </div>
      <form className="space-y-4 " onSubmit={handleSubmit}>
        <div>
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-white-700 font-medium">
              Confirm Password
            </label>
            <input
      ...
      <h2 className='my-5'> Already Registered?  <a
              href="/login">
                Log in
            </a></h2>
    </div>
